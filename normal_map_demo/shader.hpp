...
typedef std::vector<const shader_t *> shader_collection;
...
public:
	...
	static bool build(shader_program_t &shader_program, const char *vertex_shader_filepath, const char *fragment_shader_filepath);
